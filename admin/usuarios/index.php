      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
                ...
                <td> <?php echo $item['apellido_p']; ?></td>
                <td> <?php echo $item['apellido_m']; ?></td>
                ...
                <td><a href="guardar_usuario.php?id_usuario=<?php echo $item['id_usuario'] ?>" class="btn btn-warning"> Editar </td>
                <td><a href="eliminar_usuario.php?id_usuario=<?php echo $item['id_usuario'] ?>" class="btn btn-danger"> Eliminar </td>
                </tr>
                <?php endforeach; ?>
                </table>
                <?php else: ?>
