...
$marcas = Marca::recuperarTodos();


if ($id_Auto) {
    $auto = Autos::buscarPorId($id_Auto);
} else {
    $auto = new Autos;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($_FILES['imagen']['type'] == 'image/jpg' || $_FILES['imagen']['type'] == 'image/jpeg' || $_FILES['imagen']['type'] == 'image/png') {
        ...
        $auto->setIdMarca($id_Marca);
        $auto->setModelo($modelo);
        $auto->setPrecio($precio);
        $auto->setStock($stock);
        $auto->setImagen($rutaDestino);
        $auto->setTipo($tipo);
        $auto->guardar();
 ...
 window.location.href="guardar_autos.php";
 </script>';
    }
} else {
?>
                                            ...
                                            <div class="card-body p-0">
                                                <div class="row no-gutters">
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <div class="mb-5">
                                                                <h3 class="h4 font-weight-bold text-theme">Guardar Autos</h3>
                                                            </div>


                                                            <p class="text-muted mt-2 mb-5">Guardar o modificar un registro en la tabla de Autos.</p>

                                                            <form method="post" action="guardar_autos.php" enctype="multipart/form-data">
                                                                <?php if ($auto->getIdAuto()) : ?>
                                                                    <input type="hidden" name="id_Auto" value="<?php echo $auto->getIdAuto() ?>" />
                                                                    <img src="<?php echo $auto->getImagen() ?>" width="220" height="170">
                                                                    <br>
                                                                    <br>
                                                                <?php endif; ?>
                                                                <label>Autos</label>
                                                                ...
                                                                <br>
                                                                <label> Modelo </label>
                                                                <input type="text" name="modelo" class="form-control" value="<?php echo $auto->getModelo() ?>" required>
                                                                <br>
                                                                <label> Precio </label>
                                                                <input type="number" name="precio" class="form-control" value="<?php echo $auto->getPrecio() ?>" required>
                                                                <br>
                                                                <label> Stock </label>
                                                                <input type="number" name="stock" class="form-control" value="<?php echo $auto->getStock() ?>" required>
                                                                <br>
                                                                ...
                                                                <label> Tipo </label>
                                                                <br>
                                                                <input type="text" name="tipo" class="form-control" value="<?php echo $auto->getTipo() ?>" required />
                                                                <br>
                                                                <br>
                                                    ...
                                                    <div class="col-lg-6 d-none d-lg-inline-block">
                                                        <div class="account-block rounded-right">
                                                            ...
                                                            <div class="account-testimonial">
                                                                <h4 class="text-white mb-4">"Queremos que las páginas web vuelvan a ser divertidas y elegantes."</h4>
                                                                <p>- Avalanche</p>
                                                            </div>
                                                        </div>
                                                    </div>
