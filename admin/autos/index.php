      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <h1> Gestión de Autos </h1>
                <a href="guardar_autos.php" class="btn btn-success"> Nuevo Registro </a>
                <?php
                if (count($auto) > 0): ?>
                ...
                <td> <img src="<?php echo $item['imagen']; ?>" width="100" height="100" class="center-block"></td>
                <td> <?php echo $item['tipo']; ?> </td>
                <td><a href="guardar_autos.php?id_Auto=<?php echo $item['id_Auto'] ?>"  class="btn btn-warning"> Editar </td>
                <td><a href="eliminar_autos.php?id_Auto=<?php echo $item['id_Auto'] ?>"  class="btn btn-danger"> Eliminar </td>
                </tr>
                <?php endforeach; ?>
                </table>
                <?php else: ?>
