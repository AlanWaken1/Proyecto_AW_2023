                                            ...
                                            <div class="card-body p-0">
                                                <div class="row no-gutters">
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <div class="mb-5">
                                                                <h3 class="h4 font-weight-bold text-theme">Guardar Comentarios</h3>
                                                                <p class="text-muted mt-2 mb-5">Guardar o modificar un registro en la tabla de Comentarios.</p>
                                                            </div>

                                                            <form method="POST" action="guardar_comentarios.php">
                                                                <?php if ($comentario->getIdComentario()) : ?>
                                                                    <input type="hidden" name="id_Comentario" value="<?php echo $comentario->getIdComentario() ?>" />
                                                                <?php endif; ?>
                                                                <label for="email"> Email </label>
                                                                <input type="text" name="email" value="<?php echo $comentario->getEmail() ?>" class="form-control" required />
                                                                <br>
                                                                <label for="mensaje"> Mensaje </label>
                                                                <input type="text" name="mensaje" value="<?php echo $comentario->getMensaje() ?>" class="form-control" required />
                                                                <br>
                                                                <label for="fecha"> Fecha </label>
                                                                <input type="date" name="fecha" value="<?php echo $comentario->getFecha() ?>" class="form-control" required />
                                                                <br>
                                                                <label for="estatus"> Estatus </label>
                                                                <input type="text" name="estatus" value="<?php echo $comentario->getEstatus() ?> " class="form-control" required />
                                                                <br>
                                                    ...
                                                    <div class="col-lg-6 d-none d-lg-inline-block">
                                                        <div class="account-blockCom rounded-right">
                                                            <div class="overlay1 rounded-right"></div>
                                                            <div class="account-testimonial1">
                                                                <h4 class="text-white mb-4">"Diseñamos con alegría: Traemos la diversión de vuelta al mundo digital con diseños minimalistas que te hacen sonreír."</h4>
                                                                <p>- Avalanche</p>
                                                            </div>
                                                        </div>
                                                    </div>
