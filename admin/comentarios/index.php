            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <a href="guardar_comentarios.php" class="btn btn-success"> Nuevo Comentario </a>
                        <?php
                            ...
                            <table class="table table-bordered">
                                ...
                                <?php foreach ($comentario as $item) : ?>
                                    <tr>
                                        ...
                                        <td><a href="guardar_comentarios.php?id_Comentario=<?php echo $item['id_Comentario'] ?>" class="btn btn-warning"> Editar </td>
                                        <td><a href="eliminar_comentarios.php?id_Comentario=<?php echo $item['id_Comentario'] ?>" class="btn btn-danger"> Eliminar </td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                        <?php else : ?>
