                                            ...
                                            <div class="card-body p-0">
                                                <div class="row no-gutters">
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <div class="mb-5">
                                                                <h3 class="h4 font-weight-bold text-theme">Guardar Marcas</h3>
                                                            </div>


                                                            <p class="text-muted mt-2 mb-5">Guardar o modificar un registro en la tabla de Marcas.</p>

                                                            <form method="POST" action="guardar_marcas.php">
                                                                <?php if ($marca->getIdMarca()) : ?>
                                                                    <input type="hidden" name="id_Marca" class="form-control" value="<?php echo $marca->getIdMarca() ?>" />
                                                                <?php endif; ?>
                                                                <label for="nombre"> Nombre </label>
                                                                <input type="text" name="nombre" class="form-control" value="<?php echo $marca->getNombre() ?>" required />
                                                                <br>
                                                                <label for="pais"> País </label>
                                                                <input type="text" name="pais" class="form-control" value="<?php echo $marca->getPais() ?>" required />
                                                                <br>
                                                                <label> Descripción </label>
                                                                <input type="text" name="descripcion" class="form-control" value="<?php echo $marca->getDescripcion() ?>" required />
                                                                <br>
                                                    ...
                                                    <div class="col-lg-6 d-none d-lg-inline-block">
                                                        <div class="account-blockMar rounded-right">
                                                            <div class="overlay3 rounded-right"></div>
                                                            <div class="account-testimonial3">
                                                                <h4 class="text-white mb-4">"Redescubre la diversión digital: Hemos reinventado el minimalismo para agregar chispa y vivacidad a cada interacción en línea."</h4>
                                                                <p>- Avalanche</p>
                                                            </div>
                                                        </div>
                                                    </div>
