    ...
    <header id="header" class="header bg-black fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.php" class="logo d-flex align-items-center">
                <img src="../admin/assets/img/Avalanche.PNG" alt="">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <a href="guardar_marcas.php" class="btn btn-success"> Nueva Marca </a>
                        <?php
                        if (count($marca) > 0) : ?>
                            <table class="table table-bordered">
                                ...
                                <?php foreach ($marca as $item) : ?>
                                    <tr>
                                        ...
                                        <td><a href="guardar_marcas.php?id_Marca=<?php echo $item['id_Marca'] ?>" class="btn btn-warning"> Editar </td>
                                        <td><a href="eliminar_marcas.php?id_Marca=<?php echo $item['id_Marca'] ?>" class="btn btn-danger"> Eliminar </td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                        <?php else : ?>
