                        ...
                        <div class="card-body p-0">
                            <div class="row no-gutters">
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <div class="mb-5">
                                            <h3 class="h4 font-weight-bold text-theme">Registrate</h3>
                                        </div>


                                        <p class="text-muted mt-2 mb-5">Ingresa tus datos personales para registrarte en nuestro sitio web.</p>
                                        ...
                                        <form action="lib/validar_registro.php" method="post">
                                            ...
                                            <button type="submit" value="Registrar" class="btn btn-theme">Registrarme</button>
                                ...
                                <div class="col-lg-6 d-none d-lg-inline-block">
                                    <div class="account-block rounded-right">
                                        ...
                                        <div class="account-testimonial">
                                            <h4 class="text-white mb-4">"La innovación distingue entre un líder y un seguidor."</h4>
                                            <p>- Steve Jobs</p>
                                        </div>
                                    </div>
                                </div>
